...
void plot_cfactor()
{
    ...
    // read in files
    TFile *f_rho_file = new TFile(("rho_embed_PbPb_R" + jetR + "_" + pt_min + "_" + pt_max + "_46422776.root").c_str(), "READ");
    TFile *f_eec_perpcone_file = new TFile(("eec_perpcone_embed_PbPb_R" + jetR + "_" + pt_min + "_" + pt_max + "_46422776.root").c_str(), "READ");
    TFile *f_eec_mbcone_file = new TFile(("eec_mbcone_embed_PbPb_R" + jetR + "_" + pt_min + "_" + pt_max + "_46422776.root").c_str(), "READ");
    ...
    TH1D *h_eec_sb_truth = (TH1D *)f_eec_perpcone_file->Get(("h_eec_sb_truth_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());
    TH1D *h_eec_sb_perpcone = (TH1D *)f_eec_perpcone_file->Get(("h_eec_sb_perpcone_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());
    TH1D *h_eec_sb_mbcone = (TH1D *)f_eec_mbcone_file->Get(("h_eec_sb_mbcone_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());

    TH1D *h_eec_bb_truth = (TH1D *)f_eec_perpcone_file->Get(("h_eec_bb_truth_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());
    TH1D *h_eec_bb_perpcone = (TH1D *)f_eec_perpcone_file->Get(("h_eec_bb_perpcone_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());
    TH1D *h_eec_bb_mbcone = (TH1D *)f_eec_mbcone_file->Get(("h_eec_bb_mbcone_R" + jetR + "_" + pt_min + "_" + pt_max).c_str());
    ...
    h_eec_sb_perpcone->SetYTitle("perpcone / embed");
    ...
    h_eec_sb_mbcone->GetYaxis()->SetRangeUser(0.4, 1.6);
    h_eec_sb_mbcone->SetYTitle("ME cone / embed");
    ...
    c1->SaveAs(("cfactor_perpcone_R" + jetR + "_" + pt_min + "_" + pt_max + ".pdf").c_str());

    // make mbcone plot
    // set up lines
    TLine *l4 = drawHoriLine(0.01, 0.2, r_mbcone, kGreen + 2);
    TLine *l5 = drawHoriLine(0.01, 0.2, r_mbcone*r_mbcone, kRed);
    ...
    c2->SaveAs(("cfactor_mbcone_R" + jetR + "_" + pt_min + "_" + pt_max + ".pdf").c_str());
