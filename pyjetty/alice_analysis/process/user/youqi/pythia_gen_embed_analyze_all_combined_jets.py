...
class ProcessEmbedENC(process_base.ProcessBase):
    ...
    def analyze_events(self, pythia):
        ...
        iev_pbpb = 0 # Event loop count
        used_ev = []
        cs_pp = None
        jets_pp = None

        while (iev_pbpb < self.nEvents):
            
            if (jets_pp == None):
                cs_pp, jets_pp = self.get_mc_jets(pythia)
            ...
            # no acceptable SE, go to next SE
            ...
            # print("1. SE ievt:", se_iev, ", vtx =", se_vtx, ", centrality =", se_centrality)
            ...
            while (df_evts_select.shape[0] < 2):
                ...
                if (df_evts_select_se_index < df_evts_select_se.shape[0] - 1):
                    ...
                    se_centrality = self.df_evts.iloc[se_iev]["centrality"]
                    se_vtx = self.df_evts.iloc[se_iev]["z_vtx_reco"]
                    # print("2. SE ievt:", se_iev, ", vtx =", se_vtx, ", centrality =", se_centrality)
